...
export interface BtoFlatVariant {
  ...
  priceSource?: "recordbto" | "estimate";
  priceNote?: string;
}
...
export const EHG_FAMILIES_POLICY_META: EhgFamiliesPolicyMeta = {
  ...
  sourceDocument: "backend/data/policies/EHG amount Couples and Families Aug 2024.pdf",
...
export const POLICY_CONFIG = {
  ...
  sources: {
    ...
    ehgFamiliesPdf: {
      ...
      url: "local://backend/data/policies/EHG amount Couples and Families Aug 2024.pdf",
    },
  },
} as const;
