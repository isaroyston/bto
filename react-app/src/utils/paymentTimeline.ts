...
export function buildPaymentTimeline({
  ...
  return [
    ...
    },
    {
      ...
      note: "Expect the first ballot outcome.",
    },
    {
      label: "Flat booking",
      date: formatMonthYear(booking),
      note: "Choose unit and pay option fee.",
      payment: bookingPayment,
    },
    {
      label: "Agreement for lease",
      date: formatMonthYear(agreement),
      note: "Sign agreement and prepare CPF withdrawal.",
      payment: agreementPayment,
    },
    {
      label: "Key collection",
      date: formatMonthYear(key),
      note: "Final payments and keys collection.",
      payment: keyPayment,
    },
    {
